							...
							<fieldset style="margin-bottom: 10px">
								...
								<div class="form-select">
									<div class="form-group" style="float: left; width: 30%">
										...
										<input class="form-control" id="dtpassword" name="dtpassword" type="date" min="2018-12-19" max="2018-12-26" style="height: 70px; font-size: 2em;  background:#d2d6de" value="<?php echo htmlspecialchars( $delivery["dtpassword"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"></input>
									</div>
